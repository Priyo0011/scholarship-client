import fo from "../../assets/images/victory.png";
const Footer = () => {
  return (
    <footer className="mt-50 w-full py-4 px-4 sm:px-6 lg:px-8 mx-auto shadow-[#890C25] shadow-lg bg-base-200">
      <div className="text-center">
        <div className="ml-[900px]">
          <img className="w-14" src={fo} alt="" />
        </div>
        ...
        <div className="mt-3">
          <p className="text-gray-500 dark:text-neutral-500">
            We are part of the{" "}
            <a
              className="font-semibold text-[#890C25]"
              href="#"
            >
              Victory
            </a>{' '}
          ...
          <p className="text-gray-500 dark:text-neutral-500">
            © Preline. 2024 Victory. All rights reserved.
          </p>
        </div>
